...
public class Gabriel5 {
    public static void main(String[] args) {
         ...
         * Em seguida solicite o usuário que digite um valor qualquer e pesquise se o valor informado pelo usuário pertence ou não ao vetor preenchido inicialmente.
